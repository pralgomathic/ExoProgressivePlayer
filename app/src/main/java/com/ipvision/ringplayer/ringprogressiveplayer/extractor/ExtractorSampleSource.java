 ...
 */
package com.ipvision.ringplayer.ringprogressiveplayer.extractor;
...
import com.ipvision.ringplayer.ringprogressiveplayer.util.MediaFormatHolder;
import com.ipvision.ringplayer.ringprogressiveplayer.util.ParserException;
import com.ipvision.ringplayer.ringprogressiveplayer.util.SampleHolder;
import com.ipvision.ringplayer.ringprogressiveplayer.util.SampleSource;
import com.ipvision.ringplayer.ringprogressiveplayer.util.SampleSource.SampleSourceReader;
import com.ipvision.ringplayer.ringprogressiveplayer.util.TrackRenderer;
import com.ipvision.ringplayer.ringprogressiveplayer.drm.DrmInitData;
...
import com.ipvision.ringplayer.ringprogressiveplayer.upstream.DataSpec;
import com.ipvision.ringplayer.ringprogressiveplayer.upstream.DefaultAllocator;
import com.ipvision.ringplayer.ringprogressiveplayer.upstream.Loader;
import com.ipvision.ringplayer.ringprogressiveplayer.upstream.Loader.Loadable;
import com.ipvision.ringplayer.ringprogressiveplayer.util.Assertions;
 ...
 * <ul>
 * <li>Fragmented MP4
 * ({@link com.ipvision.ringplayer.ringprogressiveplayer.util.extractor.mp4.FragmentedMp4Extractor})</li>
 * <li>Unfragmented MP4, including M4A
 * ({@link com.ipvision.ringplayer.ringprogressiveplayer.util.extractor.mp4.Mp4Extractor})</li>
 * <li>Matroska, including WebM
 * ({@link com.ipvision.ringplayer.ringprogressiveplayer.util.extractor.webm.WebmExtractor})</li>
 * <li>MP3 ({@link com.ipvision.ringplayer.ringprogressiveplayer.util.extractor.mp3.Mp3Extractor})</li>
 * <li>AAC ({@link com.ipvision.ringplayer.ringprogressiveplayer.util.extractor.ts.AdtsExtractor})</li>
 * <li>MPEG TS ({@link com.ipvision.ringplayer.ringprogressiveplayer.util.extractor.ts.TsExtractor}</li>
 * <li>FLV ({@link com.ipvision.ringplayer.ringprogressiveplayer.util.extractor.flv.FlvExtractor}</li>
 * </ul>
 *
  ...
  static {
    ...
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("com.ipvision.ringplayer.ringprogressiveplayer.util.extractor.webm.WebmExtractor")
    ...
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("com.ipvision.ringplayer.ringprogressiveplayer.util.extractor.mp4.FragmentedMp4Extractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("com.ipvision.ringplayer.ringprogressiveplayer.util.extractor.mp4.Mp4Extractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("com.ipvision.ringplayer.ringprogressiveplayer.util.extractor.mp3.Mp3Extractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("com.ipvision.ringplayer.ringprogressiveplayer.util.extractor.ts.AdtsExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("com.ipvision.ringplayer.ringprogressiveplayer.util.extractor.ts.TsExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("com.ipvision.ringplayer.ringprogressiveplayer.util.extractor.flv.FlvExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
