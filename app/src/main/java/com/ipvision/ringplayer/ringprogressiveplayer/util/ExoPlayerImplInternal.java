...
import com.ipvision.ringplayer.ringprogressiveplayer.util.ExoPlayer.ExoPlayerComponent;
import com.ipvision.ringplayer.ringprogressiveplayer.util.Assertions;
import com.ipvision.ringplayer.ringprogressiveplayer.util.PriorityHandlerThread;
import com.ipvision.ringplayer.ringprogressiveplayer.util.TraceUtil;
  ...
  private void incrementalPrepareInternal() throws ExoPlaybackException {
    ...
    for (int rendererIndex = 0; rendererIndex < renderers.length; rendererIndex++) {
      ...
      for (int trackIndex = 0; trackIndex < rendererTrackCount; trackIndex++) {
        ...
        Log.d(TAG, "Track Format: " + renderer.getFormat(trackIndex));
      }
