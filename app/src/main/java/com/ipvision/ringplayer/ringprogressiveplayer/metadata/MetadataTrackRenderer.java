 ...
 */
package com.ipvision.ringplayer.ringprogressiveplayer.metadata;
...
import com.ipvision.ringplayer.ringprogressiveplayer.util.SampleSourceTrackRenderer;
  ...
  protected void doSomeWork(long positionUs, long elapsedRealtimeUs) throws ExoPlaybackException {
    ...
    if (!inputStreamEnded && pendingMetadata == null) {
      ...
      if (result == SampleSource.SAMPLE_READ) {
        ...
        Log.d("MetaDataTrackRenderer","Stream Finished");
      }
    }
